...
export declare type AirdropPaymentEvent = TypedEvent<[
    string,
    IAirdropERC721.AirdropContentStructOutput
], AirdropPaymentEventObject>;
export declare type AirdropPaymentEventFilter = TypedEventFilter<AirdropPaymentEvent>;
...
export declare type RecipientsAddedEvent = TypedEvent<[
    IAirdropERC721.AirdropContentStructOutput[]
], RecipientsAddedEventObject>;
export declare type RecipientsAddedEventFilter = TypedEventFilter<RecipientsAddedEvent>;
