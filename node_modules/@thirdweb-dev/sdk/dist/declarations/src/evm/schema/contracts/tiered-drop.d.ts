 ...
 * @public
 */
export declare type TieredDropPayloadInput = z.input<typeof TieredDropPayloadSchema>;
/**
 * @internal
 */
export declare type TieredDropPayloadOutput = z.output<typeof TieredDropPayloadSchema>;
/**
 * @internal
 */
export declare type TieredDropPayloadWithSignature = {
