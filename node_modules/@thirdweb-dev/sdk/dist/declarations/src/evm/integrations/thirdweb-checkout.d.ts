 ...
 * @internal
 */
export declare type PaperCreateCheckoutLinkIntentParams<TContract extends PrebuiltNFTDrop | PrebuiltEditionDrop | SignatureDrop> = PaperCreateCheckoutLinkShardParams & (TContract extends PrebuiltEditionDrop ? {
    contractArgs: {
        tokenId: string;
    };
